...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
			    <input type="hidden" id="create-activityId" value="045f41d80d1848cbb13841fdc674e93d">
				<input type="text" class="form-control" id="create-activityName" value="ii测试04">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
			    <input type="hidden" id="create-contactsId" value="815e401b6b324eb2a86dbd6a95924a09">
